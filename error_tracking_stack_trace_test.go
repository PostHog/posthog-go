	...
	tests := map[string]struct {
		...
		"the basic happy path with no skip or function depth": {
			...
			expectedNames: []string{
				"runtime.goexit",
				"testing.tRunner",
				"github.com/posthog/posthog-go/v2.TestDefaultStackTraceExtractor_GetStackTrace.func1",
				"github.com/posthog/posthog-go/v2.recursiveChain",
				"github.com/posthog/posthog-go/v2.DefaultStackTraceExtractor.GetStackTrace",
				"runtime.Callers",
			},
		},
